...
func (u *UserHandler) Oauth(c *gin.Context) {
	...
	if gCsrfToken == "" {
		c.HTML(200, "result.html", OutputCommonSession(u.injector, c, gin.H{
...
func (u *UserHandler) Asks(c *gin.Context) {
	...
	if err := u.db.Preload(clause.Associations).Where("id= ?", userid).First(&user).Error; err == gorm.ErrRecordNotFound {
		c.HTML(200, "profile.html", OutputCommonSession(u.injector, c, gin.H{
			"selected": "mine",
			"msg":      "请核实用户是否存在.",
		}))
		return
...
func (u *UserHandler) UserEdit(c *gin.Context) {
	...
	if uid != userid {
		c.HTML(200, "profiledit.html", OutputCommonSession(u.injector, c, gin.H{
			"selected": "mine",
			"msg":      "不允许修改非本人信息！",
		}))
		return
...
func (u *UserHandler) ToMessage(c *gin.Context) {
	...
	c.HTML(200, "message.html", OutputCommonSession(u.injector, c, gin.H{
		"selected": "message",
		"messages": messages,
		"total":    total,
	}))
...
func (u *UserHandler) InviteList(c *gin.Context) {
	...
	c.HTML(200, "inviteCode.html", OutputCommonSession(u.injector, c, gin.H{
		"selected":  "invite",
		"invites":   invites,
		"total":     total,
		"timestamp": timestamp,
...
func (u *UserHandler) ToList(c *gin.Context) {
	...
	c.HTML(200, "users.html", OutputCommonSession(u.injector, c, gin.H{
		"selected": "users",
		"users":    users,
	}))
